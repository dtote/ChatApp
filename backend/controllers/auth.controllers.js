...
export const signupFacial = async (req, res) => {
  try {
    ...
    let keys, dsaKeys;
    try {
      const keysResponse = await axios.post(`${ENV_CONFIG.PQCLEAN_API_URL}/generate_keys`, { kem_name: "ML-KEM-512" });
    ...
    try {
      const dsaKeysResponse = await axios.post(`${ENV_CONFIG.PQCLEAN_API_URL}/generate_ml_dsa_keys`, { ml_dsa_variant: "ML-DSA-44" });
...
export const signup = async (req, res) => {
  try {
    ...
    try {
      const keysResponse = await axios.post(`${ENV_CONFIG.PQCLEAN_API_URL}/generate_keys`, {
        kem_name: "ML-KEM-512",
      });
      keys = keysResponse.data;
    } catch (error) {
    ...
    try {
      dsaResponse = await axios.post(`${ENV_CONFIG.PQCLEAN_API_URL}/generate_ml_dsa_keys`, {

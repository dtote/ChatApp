            ...
            <div className='flex flex-col items-center space-y-2'>
              {!videoCaptured && (
                <>
                  ...
                  <video ref={videoRef} autoPlay className="rounded-lg w-full sm:max-w-sm h-auto bg-black" />
                  <button onClick={captureImage} type="button" className="btn btn-success">Capture Image</button>
                </>
              )}
              {videoCaptured && (
                <p className='text-green-400 text-center'>Face successfully captured! 👤</p>
              )}
            </div>
          </div>
